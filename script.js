...
function renderEnvelope() {
  ...
  /* Ouverture uniquement avec le ❤️ */
...
function renderQuestion() {
  ...
  screen(`
    <div class="fade-in">
      ...
      <p class="question">
        🌸Tu veux sortir avec moi et être ma copine
        pour que je puisse te chérir davantage ?🌸
      </p>
...
async function submitResponse() {
  ...
  */
  ...
  const payload = {
    ...
    subject:
      "❤️ Nouvelle réponse — Riyad et Nafi",
  ...
  try {
    ...
    */
    ...
    console.log(
      "❤️ Réponse envoyée avec succès à Formspree !"
    );
    ...
    console.error(
      "❌ Impossible d'envoyer la réponse à Formspree :",
      error
    );

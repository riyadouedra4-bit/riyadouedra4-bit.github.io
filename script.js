...
async function submitResponse() {
  ...
  /*
    Pour l'instant, aucun service d'envoi
    n'est encore configuré.

    Lorsque nous aurons configuré le service
    d'envoi, l'adresse sera enregistrée ici
    automatiquement.
  */
  ...
  if (!endpoint) {
    ...
    console.log(
      "Aucun endpoint de réponse configuré."
    );
